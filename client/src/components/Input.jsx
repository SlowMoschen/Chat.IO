export default function Input({ placeholder, type, name, id, errorMessage, onChange, autoComplete}) {
    ...
    return (
        <>
            <div className="flex flex-col w-full my-2 relative">
                ...
                <input type={type} name={name} id={id} className={inputClasses} placeholder={placeholder} onChange={onChange} autoComplete={autoComplete}/>
